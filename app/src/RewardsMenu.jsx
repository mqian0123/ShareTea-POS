        ...
        return (
            ...
            <div className = "flex flex-col bg-amber-50">
                ...
                <div className = "flex items-center justify-between p-5">
                    ...
                    <div className='flex gap-10 border p-5 rounded-full bg-white'>
                        <button onClick={zoomIn} className='hover:cursor-pointer'>
                            +
                        </button>
                        <button onClick = {zoomOut} className='hover:cursor-pointer'>
                            -
                        </button>
                    </div>
