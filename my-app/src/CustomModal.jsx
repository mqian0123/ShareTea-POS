            ...
            <div id="static-modal" data-modal-backdrop="static" tabIndex="-1" aria-hidden="true" className="overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                    <div className="relative p-4 w-full max-w-2xl max-h-full">
                        ...
                        <div className="p-4 md:p-5 space-y-4">
                            ...
                            <ul className="items-center w-full text-sm text-white bg-gradient-to-br from-pink-500 to-orange-400 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-pink-200 dark:focus:ring-pink-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 sm:flex">
                                <li className="w-full border-b border-gray-200 sm:border-b-0">
                                    <div className="flex items-center ps-3">
                                        <input onChange = {handleRadioChange1} id="blackTea" type="radio" value="Black Tea" name="list-radio-1" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500" />
                                        <label htmlFor="blackTea" className="w-full py-3 ms-2 text-sm font-medium">Black Tea</label>
                                    </div>
                                </li>
                                <li className="w-full border-b border-gray-200 sm:border-b-0">
                                    <div className="flex items-center ps-3">
                                        <input onChange = {handleRadioChange1} id="greenTea" type="radio" value="Green Tea" name="list-radio-1" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500" />
                                        <label htmlFor="greenTea" className="w-full py-3 ms-2 text-sm font-medium">Green Tea</label>
                                    </div>
                                </li>
                                <li className="w-full border-b border-gray-200 sm:border-b-0">
                                    <div className="flex items-center ps-3">
                                        <input onChange = {handleRadioChange1} id="oolongTea" type="radio" value="Oolong Tea" name="list-radio-1" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500" />
                                        <label htmlFor="oolongTea" className="w-full py-3 ms-2 text-sm font-medium">Oolong Tea</label>
                                    </div>
                                </li>
                            </ul>
                        </div>
                            ...
                            <button onClick={() => {addToOrder(itemName, itemPrice, img, toppingsList, selectedIceLevel, selectedSugarLevel, selectedTeaType);
                                onClose();
