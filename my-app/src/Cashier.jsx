    ...
    return (
        <div className = "flex flex-col ">
            ...
            <div className = "flex items-center justify-between p-5">
                ...
                <div className = "flex items-center">
                    {/* TODO: Dynamically update the number of orders placed by that employee during that day*/}
            ...
            <div className = "flex ml-5 mb-5">
                ...
                <div className = "w-2/5 bg-white rounded-l-3xl grid auto-rows-min h-min ">
                    ...
                    <div className='grid m-5 auto-rows-min'>
                        ...
                        <SwipeableOrderButton setOrderList={setOrderList} clearUserName = {clearUserName} setSelectedTable = {setSelectedTable} setPhoneNumber = {setPhoneNumber} setCustomerID = {setCustomerID}
                                // TODO: check following scenarios:
                                // 1. If no phone number inserted, user customerID = 1
                                // 2. If number inserted but does not exist, add to database
                                // 3. If number inserted and does exist, set customerID to corresponding ID
                                data={
                                    {     
                                    time: new Date(),
